    ...
    try {
      ...
      const reservationData = {
        ...
        number_of_players: formData.number_of_players
          ? parseInt(formData.number_of_players)
          : null,
      ...
      alert(
        "Rezerwacja utworzona pomyślnie! Sprawdź swój email w celu potwierdzenia."
      );
      onSuccess();
    } catch (error) {
      setError(
        error.response?.data?.error || "Nie udało się utworzyć rezerwacji"
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="modal-overlay">
      <div className="modal">
        ...
        >
          <p>
            <strong>Boisko:</strong> {selectedField.name}
          </p>
          <p>
            <strong>Data:</strong>{" "}
          ...
          {selectedField.hourly_rate && (
            <p>
              <strong>Cena:</strong> {selectedField.hourly_rate} PLN/godz.
            </p>
          )}
        </div>
