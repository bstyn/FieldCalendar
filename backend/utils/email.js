  ...
  try {
    const mailOptions = {
      ...
      html: `
        ...
        <ul>
          <li><strong>Data rozpoczęcia:</strong> ${new Date(
            reservation.start_time
          ).toLocaleString("pl-PL")}</li>
          <li><strong>Data zakończenia:</strong> ${new Date(
          ...
          ${
            reservation.number_of_players
              ? `<li><strong>Liczba graczy:</strong> ${reservation.number_of_players}</li>`
              : ""
          }
        </ul>
        ${
